...
MAXLENGTH = 11;     // maximum number of digits before decimal!
 ...
 { 
  ...
  if (Operation == 2)
    { if (eval(Current) != 0)
      ...
      { Current = "Error! Divide by zero"; //don't allow over MAXLENGTH digits before "." ???
      }
    };
  ...
  if (Current.indexOf("Infinity") != -1)        //eg "1e320" * 1
    { Current = "Error! Value too big";
    };
  if (Current.indexOf("NaN") != -1)        //eg "1e320" / "1e320"
    { Current = "Error! I don't understand";
    };
  document.Calculator.Display.value = Current;
